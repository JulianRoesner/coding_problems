//Depth First Search for binary tree, for this exercise I just return all the values, that we looked through until the value was found instead of really searching for the value
import Swift 
class Node: CustomStringConvertible{
	...
	public func search(_ value: Int) -> [Int]{
		...
		if(self.leftChild != nil){
			returnArray.append(contentsOf: self.leftChild!.search(value))
		}
		if(self.rightChild != nil){
			returnArray.append(contentsOf: self.rightChild!.search(value))
		}

		returnArray.append(self.value)
		return returnArray
